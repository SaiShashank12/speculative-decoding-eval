...
class LlamaAttention(nn.Module):
    ...
    def _init_rope(self):
        if self.config.rope_scaling is None:
            ...
            scaling_type = self.config.rope_scaling.get("type", self.config.rope_scaling.get("rope_type", "linear"))
            ...
            if scaling_type == "linear":
                ...
                self.rotary_emb = LlamaRotaryEmbedding(
                    self.head_dim, max_position_embeddings=self.max_position_embeddings, base=base
                )
            else:
